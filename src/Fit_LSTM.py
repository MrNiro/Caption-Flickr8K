...
class LstmCaption:
    def __init__(self, encoder, if_load=True):
        ...
        if if_load:
            self.model.load_weights("model-vgg-lstm-best.h5")
        self.model.summary()
    ...
    def setup_model(self):
        ...
        lstm_1 = LSTM(middle_units)(dropout_2)
    ...
    def training(self):
        ...
        for i in range(0, 10):
            ...
            model_file_name = ("model-vgg-lstm-epoch%d.h5" % (100*(i+1)))
    ...
    def predicting(self):
        ...
        for i in range(40):
            ...
            plt.show()
            plt.pause(0)
        print("Average score =", whole_score / 40)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 2:
        if sys.argv[2] == "train":
            myCaption = LstmCaption(encoder=encoder, if_load=False)
            myCaption.training()
        elif sys.argv[2] == "predict":
            myCaption = LstmCaption(encoder=encoder, if_load=True)
